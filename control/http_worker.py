...
class HTTPWorker(QObject):
    """
    Kelas untuk menangani operasi HTTP dan pembaruan model akun.
    """
    ...
    def update_balances(self, balances):
        ...
        Args:
            balances (dict): Data saldo yang diambil dari API.
        """
    ...
    def validate_pair(self, pair):
        """
        Memvalidasi pasangan mata uang dengan melakukan permintaan HTTP.
