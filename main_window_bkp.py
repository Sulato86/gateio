...
class MainWindow(QMainWindow, Ui_MainWindow):
    """
    Kelas MainWindow mengatur antarmuka utama aplikasi dan mengelola interaksi dengan API Gate.io.

    Attributes:
        api_key (str): Kunci API Gate.io.
        api_secret (str): Kunci rahasia API Gate.io.
        pairs (list): Daftar pasangan mata uang.
        data_market (DataFrame): DataFrame untuk data pasar.
        proxy_model_market (CustomSortFilterProxyModel): Proxy model untuk data pasar.
        data_account (DataFrame): DataFrame untuk data akun.
        proxy_model_account (CustomSortFilterProxyModel): Proxy model untuk data akun.
        worker (QThreadWorker): Worker thread untuk pengambilan data pasar.
        balance_worker (BalanceWorker): Worker thread untuk pengambilan saldo akun.
    """

    def __init__(self):
        """
        Inisialisasi MainWindow dengan mengatur antarmuka pengguna dan memulai worker threads.
        """
        super().__init__()
        self.setupUi(self)
    ...
    def init_signals(self):
        """
        Menghubungkan sinyal dan slot untuk interaksi antarmuka pengguna.
        """
    ...
    def import_pairs(self):
        """
        Mengimpor pasangan mata uang dari file CSV dan memperbarui data pasar.
        """
    ...
    def update_model_market(self, data_frame):
        """
        Memperbarui model data pasar dengan DataFrame baru.

        :param data_frame: DataFrame baru yang berisi data pasar.
        """
    ...
    def update_model_account(self, data_frame):
        """
        Memperbarui model data akun dengan DataFrame baru.

        :param data_frame: DataFrame baru yang berisi data akun.
        """
